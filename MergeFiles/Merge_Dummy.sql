...
SELECT 2 AS Id, 'Mayur' AS Name, ' 1-389-296-7131' AS PhoneNumber, 'Mumbai' AS City UNION ALL
SELECT 3 AS Id, 'Ibrahim' AS Name, ' 1-389-296-7132' AS PhoneNumber, 'Banglore' AS City UNION ALL
SELECT 4 AS Id, 'Narender' AS Name, '8-555-896-7414' AS PhoneNumber, 'Jaipure' AS City 
