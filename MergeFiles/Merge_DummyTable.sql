...
SELECT 100 AS Id, 'Mayur' AS Name, ' 1-389-296-7131' AS PhoneNumber, ' Orsara di Puglia' AS City UNION ALL
SELECT 101 AS Id, 'Ibrahim' AS Name, ' 1-389-296-7131' AS PhoneNumber, ' Orsara di Puglia' AS City UNION ALL
SELECT 102 AS Id, 'Narender' AS Name, ' 1-389-296-7131' AS PhoneNumber, ' Orsara di Puglia' AS City UNION ALL
SELECT 103 AS Id, 'Akhay' AS Name, ' 1-389-296-7131' AS PhoneNumber, ' Orsara di Puglia' AS City 
