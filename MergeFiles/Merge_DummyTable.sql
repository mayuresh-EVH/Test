...
SELECTPrimaryKey2AS 2 , IdAS 'Risa' , NameAS ' 369-5600' , PhoneNumberAS ' Titagarh , New York' AS City UNION ALL
...
SELECT 101 AS Id, 'Ibrahim' AS Name, ' 1-389-296-7132' AS PhoneNumber, 'Banglore' AS City UNION ALL
SELECT 102 AS Id, 'Narender' AS Name, '8-555-896-7414' AS PhoneNumber, 'Banglore' AS City 
